...
## Escopo e Atividades Desenvolvidas
...
- Implementação do banco de dados no MySQL
...
- 🖼️ **Imagens**
  Diagramas e modelos do projeto, incluindo:
    ...
    - Representação da modelagem lógica
...
✅ Projeto concluído  
📚 Utilizado como projeto acadêmico e portfólio técnico  
